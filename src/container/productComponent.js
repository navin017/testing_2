          ...
          {showDetails[product.id] && (
            <table className='viewForm' data-testid='viewDetails'>
              <tbody>
                ...
                <tr>
                  <td>
                    <button onClick={() => closeViewHandler(product.id)} className='close-view-btn'>Close</button>
                  </td>
                  <td>
                    <button onClick={() => handleEditProduct(product)} className='edit-view-btn'>Edit</button>
                  </td>
                </tr>
              </tbody>
            </table>
